...
COMPLETED_TRANSCRIPTIONS_DIR = (
    "/home/alexander/pyProjects/sermonTranscriber/main/completed_transcriptions"
)
...
def check_remote_db():
    ...
    try:
        ...
        cursor = conn.cursor()
        cursor.execute(
            "SELECT id, mp3_id, mp3_path, transcript_path, status, processing_time_seconds FROM files"
        )
