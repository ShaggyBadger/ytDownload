...
class JobSetupController:
    ...
    def _handle_manual_entry(self):
        ...
        try:
            ...
            self.console.print("[red]An error occurred during manual entry. Check logs.[/red]")
    ...
    def _handle_csv_entry(self):
        ...
        try:
            ...
            self.console.print("[red]An error occurred during CSV entry. Check logs.[/red]")
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                logger.critical(f"An unhandled error occurred while running '{selected_option.get('desc')}' in Job Setup Menu.", exc_info=True)
