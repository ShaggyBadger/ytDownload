...
class FormatTranscriptionController:
    ...
    def run(self):
        while True:
            ...
            if choice == "1":
                ...
                self.console.print("[yellow]Not yet implemented. Coming soon![/yellow]")
    ...
    def format_all_transcriptions(self):
        ...
        with self.console.status("[bold green]Searching for transcriptions to format...[/bold green]", spinner="dots") as status:
            try:
                    ...
                    jobs_to_format = (
                        ...
                        .filter(JobInfo.stages.any(
                            and_(
                                ...
                                (JobStage.state == StageState.pending) | (JobStage.state == StageState.failed)
                            )
                        ))
                        .all()
                    )
